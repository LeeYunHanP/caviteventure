...
// New Cloudinary image URLs for San Roque Church page
const bannerImage =
  "https://res.cloudinary.com/dxr6eovhv/image/upload/v1744810300/inside_wa3ypq.webp";
const galleryImage1 =
  "https://res.cloudinary.com/dxr6eovhv/image/upload/v1744810301/sanroque1_wyz0fz.jpg";
const galleryImage2 =
  "https://res.cloudinary.com/dxr6eovhv/image/upload/v1744810301/inside2_mccvdu.jpg";
const galleryImage3 =
  "https://res.cloudinary.com/dxr6eovhv/image/upload/v1744810302/sanroque_eabsul.png";
  ...
  return (
    <div className="bg-[#f5f0e5]">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 relative">
        ...
        <div className="absolute left-1/4 top-32 bottom-12 w-1 hidden md:block bg-gradient-to-b from-[#3E2723] to-[#A1887F]"></div>
        <motion.h2
          ...
          <motion.div className="flex flex-col md:flex-row" variants={itemVariants}>
            ...
            <div className="md:w-3/4 bg-white/50 p-8 rounded-lg shadow-sm border border-[#A1887F]">
              <p className="text-xl text-[#3E2723] leading-relaxed">
                San Roque Church is said to have been established around 1573. Its humble beginnings laid the groundwork for centuries of devotion,
                community gatherings, and historical events that shaped Cavite&apos;s heritage.
              </p>
            </div>
          </motion.div>
          {/* Colonial Upheavals */}
